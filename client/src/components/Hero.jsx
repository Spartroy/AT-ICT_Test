          ...
          >
            ...
            >
              <div className="flex space-x-1">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 sm:w-6 sm:h-6 text-[#CA133E]" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="relative bg-gray-800 rounded-xl overflow-hidden border-4 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] w-full max-w-[750px] border-[#CA133E]">
              ...
              {showVideo ? (
                ...
                <div className="h-full bg-gray-800 flex items-center justify-center relative">
                  ...
                  {/* Play button */}
                  <div
                    className="relative z-10 w-[60px] h-[60px] sm:w-[80px] sm:h-[80px] lg:w-[92px] lg:h-[92px] bg-[#333333] rounded-full cursor-pointer hover:scale-110 transition-all transform flex items-center justify-center"
                  ...
                  >
                    <svg className="w-[25px] h-[25px] sm:w-[35px] sm:h-[35px] lg:w-[40.41px] lg:h-[40.41px] text-[#CD143F] ml-1" fill="currentColor" viewBox="0 0 20 20" style={{ filter: 'drop-shadow(inset 3px 4px 6.1px rgba(0, 0, 0, 0.13))' }}>
